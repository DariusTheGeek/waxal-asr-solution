...
def _frozen_spec_and_profiles() -> tuple[Path, Path]:
    ...
    experiment = (
        ROOT
        / "experiments/omniasr_ctc_3b_v2/mono/sna/supervised_ft"
        / "control_max12_target_es/X0044_20260806T153728361013Z_ctc3b_v2_sna_cv002_fsdp2_seed42"
    )
    return experiment / "experiment.yaml", experiment / "profiles"
...
def test_relocatable_card_render(tmp_path: Path, monkeypatch) -> None:
    ...
    assert str(ROOT / "models/omniasr-ctc-3b-v2") in text
