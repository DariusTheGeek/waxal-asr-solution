#!/usr/bin/env python3
"""Fail-closed averaging for consolidated CTC checkpoints.
...
def resolve_sources(
    ...
    *,
    ...
    if observed_steps != curve_top_steps or observed_steps != sorted(observed_steps):
        raise CheckpointAverageError(
...
def build_average(
    *,
    ...
    try:
        ...
        if lengths_after != lengths_before or not torch.equal(logits_after, logits_before):
